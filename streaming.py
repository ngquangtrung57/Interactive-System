...
def analysis(
    ...
    Args:
        ...
        unfreeze_threshold (int): The frame threshold to determine when to unfreeze the model.
    Returns:
        None
    """
    # initialize models
    ...
    while True:
        ...
        elif freeze is True and time.time() - tic > time_threshold and num_frames_with_faces > unfreeze_threshold:
            freeze = False
            freezed_img = None
